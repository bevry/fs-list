...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/fs-list@^1.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/fs-list@^1.0.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/fs-list@1.0.0'
</script>
```
...
<a href="https://github.com/bevry/fs-list/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a>
...
<a href="https://github.com/bevry/fs-list/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a>
...
<ul><li><a href="https://balupton.com">Benjamin Lupton</a> — <a href="https://github.com/bevry/fs-list/commits?author=balupton" title="View the GitHub contributions of Benjamin Lupton on repository bevry/fs-list">view contributions</a></li></ul>
